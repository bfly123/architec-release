    ...
    target.write_text(
        "\n".join(
            [
                ...
                "",
                "```powershell",
                "powershell -NoProfile -ExecutionPolicy Bypass -Command \"$i=Join-Path $env:TEMP 'install_prod.ps1'; Invoke-WebRequest 'https://www.architec.top/downloads/latest/install_prod.ps1' -OutFile $i; & $i\"",
                "```",
                "",
                ...
                "",
                "Windows users should use the PowerShell installer. It installs the Windows binary, the Python support packages, starter configs, and Codex / Claude skills.",
                "",
                "安装器会自动：",
                "",
                "- 安装 `archi`",
